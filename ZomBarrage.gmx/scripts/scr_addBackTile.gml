...
_x += back_tile_width * xoff;
_y += back_tile_height * yoff;
...
var tiles_per_height = bg_height / back_tile_height;
var total_tiles = tiles_per_width * tiles_per_height;
var tl_x = (tileNum mod tiles_per_width)  * back_tile_width;
//var tl_y = (tileNum div tiles_per_height) * back_tile_height - back_tile_height;
var tl_y = floor(tileNum / tiles_per_width) * back_tile_height;
//show_message("X: " + string(tl_x) + ", Y: " + string(tl_y) + ", tiles_per_w: " + string(tiles_per_width));
//show_message("tileNum = " + string((tl_y * tiles_per_height) / (back_tile_height * tiles_per_height)));

tile_add(tile_back, tl_x, tl_y, back_tile_width, back_tile_height, _x, _y, _depth);